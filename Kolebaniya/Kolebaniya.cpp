...
// Kolebaniya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKolebaniyaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKolebaniyaApp

CKolebaniyaApp::CKolebaniyaApp()
{
...
// Единственный объект CKolebaniyaApp

CKolebaniyaApp theApp;


// Инициализация CKolebaniyaApp

BOOL CKolebaniyaApp::InitInstance()
{
